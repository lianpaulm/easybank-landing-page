      ...
      <div className=" md:h-[100vh] md:max-h-[736px] md:items-center md:grid-cols-[1fr_1fr] grid gap-[1.8rem] md:gap-1 mx-auto max-w-6xl">
        ...
        <div className="md:order-1 relative h-[355px] ">
          ...
          <img
            ...
            alt="mobile mockups"
            className="2xl:max-w-[760px] 2xl:top-[-15rem] xl:max-w-[680px] xl:top-[-10rem] lg:top-[-8rem] lg:max-w-[560px] lg:left-[65px] md:top-[-6rem] md:max-w-[490px] md:left-[65px] md:bottom-[unset] md:translate-x-0 absolute max-w-[340px] bottom-0 left-[50%] translate-x-[-50%]"
          />
        </div>
